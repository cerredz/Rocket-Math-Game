...
const handleCorrectAnswer = () => {
    ...
    setCoins(prevCoins => prevCoins + (parseInt(correctStreak / 2) + 1))
...
useEffect(() => {
    if(correctAnswers > 0 && !timeLeft) {
        ...
        console.log('coins / correctAnswers:', correctAnswers + parseInt(coins / correctAnswers));
...
return (
    <div>
        ...
        {playNow && !showCountDown && !timeLeft && (
            <div className='competitive-container'>
                <div style={gameContainerStyle} className='competitive-game'>
                    <h3 className='casual-heading-text'>Results</h3>
